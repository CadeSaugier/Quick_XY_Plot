#This program will plot histograms corresponding to each .xy file input in one plot with varying sized bins.
...
def main():
	...
	for i in range(len(fileName)):
		...
		pyplot.step(dataX[i],dataY[i],where='pre',label=fileName[i])
	print('\n')
